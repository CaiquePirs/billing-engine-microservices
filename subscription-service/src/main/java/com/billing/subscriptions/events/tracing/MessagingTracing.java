package com.billing.subscriptions.events.tracing;

import com.billing.subscriptions.events.data.SnsMessage;
import com.billing.subscriptions.events.data.SnsMessageAttribute;
 ...
 * downstream DB/HTTP/SNS spans) joins the same trace instead of starting a new one.
 */
@Component
